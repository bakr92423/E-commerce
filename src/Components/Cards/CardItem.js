...
<div className="container my-4 CardItem ">
  <div className="row justify-content-center">
    <div className="col-12 col-md-10  d-flex flex-wrap align-items-center justify-content-between p-3 rounded">
      ...
      <div className="col-3 col-sm-6 col-md-3 text-center mb-4 mb-md-0">
        <img src={image} alt=" " className="img-fluid" />
      </div>

      <div className="col-3 col-sm-6 col-md-3 text-center mb-3 mb-md-0">
        <p className="mb-0">السعر: {price}جنية</p>
      </div>

      <div className="col-3 col-sm-6 col-md-2 text-center d-flex flex-column boxCount ">
      ...
      <div className="col-3 col-sm-6 col-md-3 text-center xmark ">
